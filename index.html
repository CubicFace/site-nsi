                ...
                <!-- Menu de nav -->
                    <nav class="main-nav">
                        ...
                        <ul class="nav-list">
                            ...
                            <li class="nav-btn">
                                <v-btn text :dark="darkMode" href="index.html">Acceuil</v-btn>
                            </li>
                            <li class="nav-btn">
                                <v-btn text :dark="darkMode" href="classes.html">Classes</v-btn>
                            </li>
                            <li class="nav-btn">
                                <v-btn text :dark="darkMode" @click.stop="contactEnabled = true">Contact / Connexion</v-btn>
                            </li>
            ...
            <!-- Il faut trouvé je pense des img pour illustrer un peu la page d'accueil -->
                ...
                >
                    <v-list dense>
                        ...
                        <v-list-item
                            @click.stop="contactEnabled = true"
                        >
                ...
                >
                    <v-card>
                        ...
                        <div class="d-flex flex-lg-row flex-md-row flex-column  justify-space-around py-5 align-center">
                            <v-btn :dark="darkMode" class="mb-lg-0 mb-md-0 mb-2" max-width="300px" href="https://scharles.net">Site de Saint-Charles</v-btn>
                            <v-btn :dark="darkMode" class="mt-lg-0 mt-md-0 mt-2" max-width="300px" href="mailto:thedjplays.gaming@gmail.com">Envoyer un e-mail au prof</v-btn>
                        </div>
                        ...
                        <div class="d-flex flex-lg-row flex-md-row flex-column  justify-space-around py-5 align-center">
                            <v-btn :dark="darkMode" class="mb-lg-0 mb-md-0 mb-2" max-width="300px" @click.stop="logIn=!logIn">Se connecter / S'inscrire</v-btn>
                        </div>
                        <v-dialog
                        v-model="logIn"
                        >
                ...
                <p>
                    Hey, toi qui regarde notre site je te remercie de ta visite, tu trouveras ci-joint des doccuments qui pourront t'interréssé : des cours , des projets afin que tu puisse enrichir tes connaissances 
                </p>  
