...
<body>
    <div id="main">
        <v-app>
            ...
            <v-carousel cycle height="640px" show-arrows show-arrows-on-hover>
                <v-carousel-item v-for="item in carouselItems" :src="item.src">
                </v-carousel-item>
                <v-carousel-item v-for="color in carouselPlaceholder">
